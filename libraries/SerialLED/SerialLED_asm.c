...
CLOCAL 47H 0002H 0027H 0002H "i" 02H 00H 08H
CLOCAL 46H 0001H 0017H 0002H "tmp" 02H 00H 00H
...
CLOCAL 46H 0001H 0016H 0002H "port_data1" 02H 00H 00H

;;	port = ml620504f_pin_to_port[digital_pin_to_port[led_pin]];
CLINEA 0000H 0001H 0019H 0002H 003CH
	l	r0,	NEAR _led_pin
	mov	r1,	#00h
...
CLINEA 0000H 0001H 001CH 0002H 0034H
	l	r4,	[er10]
	mov	er6,	er2
...
CLINEA 0000H 0001H 001DH 0002H 0034H
	l	r2,	[er10]
	l	r3,	NEAR _ml620504f_pin_to_bit[er6]
	or	r2,	r3

;;	*port = port_data0;					// initializing port
CLINEA 0000H 0001H 001FH 0002H 002DH
	st	r4,	[er10]
...
;;start:
CLINEA 0000H 0001H 0023H 0001H 0006H
CLABEL 0002H "start"
_$L2 :

;;	*port = port_data1;
CLINEA 0000H 0001H 0024H 0002H 0014H
	st	r2,	[er10]

;;	if((tmp&0x80)==0)
CLINEA 0000H 0001H 0025H 0002H 0012H
	tb	r3.7
	bne	_$L3
CBLOCK 196 3 38

;;		__asm("nop");				// 0-0
CLINEA 0000H 0001H 0027H 0003H 0019H
nop
...
;;		__asm("nop");
CLINEA 0000H 0001H 0029H 0003H 000FH
nop

;;		*port = port_data0;
CLINEA 0000H 0001H 002AH 0003H 0015H
	st	r5,	[er10]

;;		__asm("nop");
CLINEA 0000H 0001H 002CH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 002DH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 002EH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 002FH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0030H 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0031H 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0032H 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0033H 0003H 000FH
nop
CBLOCKEND 196 3 52

;;	else
CLINEA 0000H 0001H 0035H 0002H 0005H
	bal	_$L5
_$L3 :
CBLOCK 196 4 54
...
;;		__asm("nop");
CLINEA 0000H 0001H 0038H 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0039H 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 003AH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 003BH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 003CH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 003DH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 003EH 0003H 000FH
nop
...
;;		__asm("nop");
CLINEA 0000H 0001H 0041H 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0042H 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0043H 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0044H 0003H 000FH
nop
CBLOCKEND 196 4 69
...
;;	tmp <<=1;
CLINEA 0000H 0001H 0046H 0002H 000AH
	sll	r3,	#01h

;;	*port = port_data1;
CLINEA 0000H 0001H 0047H 0002H 0014H
	st	r2,	[er10]

;;	if((tmp&0x80)==0)
CLINEA 0000H 0001H 0048H 0002H 0012H
	tb	r3.7
	bne	_$L6
CBLOCK 196 5 73
...
;;		__asm("nop");
CLINEA 0000H 0001H 004BH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 004CH 0003H 000FH
nop

;;		*port = port_data0;
CLINEA 0000H 0001H 004DH 0003H 0015H
	st	r5,	[er10]

;;		__asm("nop");
CLINEA 0000H 0001H 004FH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0050H 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0051H 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0052H 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0053H 0003H 000FH
nop
...
;;	else
CLINEA 0000H 0001H 0058H 0002H 0005H
	bal	_$L8
_$L6 :
CBLOCK 196 6 89

;;		__asm("nop");				// 1-1
CLINEA 0000H 0001H 005AH 0003H 0019H
nop

;;		__asm("nop");
CLINEA 0000H 0001H 005BH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 005CH 0003H 000FH
nop
...
;;		__asm("nop");
CLINEA 0000H 0001H 005EH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 005FH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0060H 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0061H 0003H 000FH
nop

;;		*port = port_data0;
CLINEA 0000H 0001H 0063H 0003H 0015H
	st	r5,	[er10]

;;		__asm("nop");
CLINEA 0000H 0001H 0064H 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 0065H 0003H 000FH
nop
