 ...
 *                          (Setting value of FT2MOD register)                  <br>
 ...
 *                          (Setting value of FT2CLK register)                  <br>
 *                          Specify the logical sum of the following items.
 ...
 */
#define         ftimer2_init( ftnmod, ftnclk )                  do {                                                    \
                                                                    write_reg16( FT2MOD, (unsigned short)(ftnmod) );    \
                                                                    write_reg16( FT2CLK, (unsigned short)(ftnclk) );    \
                                                                } while (0)
 ...
 *                          (Setting value of FT2TRG0 register)                 <br>
 *                          Specify the logical sum of the following items.
 ...
 *                          (Setting value of FT2TRG1 register)                 <br>
 *                          Specify the logical sum of the following items.
 ...
 * @return      None
 */
#define         ftimer2_setTriggerParam( ftntrg0, ftntrg1 )     do {                                                    \
                                                                    write_reg16( FT2TRG0, (unsigned short)(ftntrg0) );  \
                                                                    write_reg16( FT2TRG1, (unsigned short)(ftntrg1) );  \
                                                                } while (0)
 ...
 *                          (Setting value of FT2INTE register)                 <br>
 *                          Specify the logical sum of the following items.
 ...
 * @return      None
 */
#define         ftimer2_setInt( ftninte )       write_reg16( FT2INTE, (unsigned short)(ftninte) )

/**
 * Setting cycle counter
 *
 * @param[in]   ftnp        Cycle of timer counting                             <br>
 *                          (Setting value of FT2P register)                    <br>
 *                          Set this value form 1 to 0xFFFF.                    <br>
 * 
 * @return      None
 */
#define         ftimer2_setCycle( ftnp )        write_reg16( FT2P, (unsigned short)(ftnp) )

/**
 * Setting event counter A
 *
 * @param[in]   ftnea       Setting value of FT2EA register                     <br>
 ...
 * @return      None
 */
#define         ftimer2_setEventCntA( ftnea )   write_reg16( FT2EA, (unsigned short)(ftnea) )

/**
 * Setting event counter B
 *
 * @param[in]   ftneb       Setting value of FT2EB register                         <br>
 *                              [for Timer]     : the count of interrupt trigger    <br>
 *                              [for PWM]       : the duty of TMOUT output          <br>
 *                              [for Capture]   : invalid
 * 
 * @return      None
 */
#define         ftimer2_setEventCntB( ftneb )   write_reg16( FT2EB, (unsigned short)(ftneb) )

/**
 * Setting DeadTime
 *
 * @param[in]   ftndt       Setting value of FT2DT register                                     <br>
 *                              [for Timer/PWM] : the clock of DeadTime ( 0 : Not-DeadTime )    <br>
 *                              [for Capture]   : invalid
 * @return      None
 */
#define         ftimer2_setDeadtime( ftndt )    write_reg16( FT2DT, (unsigned short)(ftndt) )

/**
 * Start FTimer
 *
 * @param[in]   ftncon0     Setting value of FT2CON0 register                                   <br>
 *                          Specify the logical sum of the following items.
 ...
 * @return      None
 */
#define         ftimer2_start( ftncon0 )        write_reg8( FT2CON0, (unsigned char)( (ftncon0)|FTnCON0_FTnRUN ) )
 ...
 * @return      None
 */
#define         ftimer2_stop()                  clear_bit( FT2RUN )
 ...
 *              (A value of FT2C register)      <br>
 */
#define         ftimer2_getCnt()                read_reg16( FT2C )
 ...
 *              (A value of FT2EA register)     <br>
 * @note        This macro is Capture mode only.
 */
#define         ftimer2_getEventCntA()          read_reg16( FT2EA )
 ...
 * @param       -
 * @return      The value of capture result     <br>
 *              (A value of FT2EB register)     <br>
 * @note        This macro is Capture mode only.
 */
#define         ftimer2_getEventCntB()          read_reg16( FT2EB )
 ...
 * @return      None
 */
#define         ftimer2_trigUpdateDutyCycle()   set_bit( FT2UD )
 ...
 */
#define         ftimer2_checkEnaUpdate()        ( (unsigned char)get_bit( FT2UD ) )
 ...
 * @param       -
 * @return      Status                          <br>
 *              (A value of FT2CON0 register)   <br>
 */
#define         ftimer2_getStatus()             read_reg8( FT2CON0 )
 ...
 *              (A value of FT2INTS register)
 */
#define         ftimer2_getIntCause()           read_reg16( FT2INTS )

/**
 * Clear interrupt cause
 *
 * @param[in]   ftnintc     Mask value to clear interupt cause                  <br>
 *                          (Setting value of FT2INTC register)                 <br>
 *                          Specify the logical sum of the following items.
 ...
 * @return      None
 */
#define         ftimer2_clearIntCause( ftnintc ) write_reg16( FT2INTC, (unsigned short)(ftnintc) )
